...
CHART_FILE="${ROOT_DIR}/charts/external-service-discovery-operator/Chart.yaml"
...
chart="${ROOT_DIR}/dist/helm/external-service-discovery-operator-${CHART_VERSION}.tgz"
